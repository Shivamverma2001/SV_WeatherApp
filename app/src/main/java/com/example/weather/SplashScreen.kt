...
class SplashScreen : AppCompatActivity() {
    ...
    var fine="android.permission.ACCESS_FINE_LOCATION"
    var coarse="android.permission.ACCESS_COARSE_LOCATION"
...
//    4. permission le lo
    ...
    private fun RequestPermission() {
        ActivityCompat.requestPermissions(this, arrayOf(coarse,
            fine),myResquestCode)
    }

    private fun CheckPermission(): Boolean {
        if(
            ActivityCompat.checkSelfPermission(this,fine)== PackageManager.PERMISSION_GRANTED ||
